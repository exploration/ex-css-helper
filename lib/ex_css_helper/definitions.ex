defmodule ExCssHelper.Definitions do
  ...
  "classes" => %{
    ...
    "select" => "input-reset w-100 pa2 pr4 ba br1 x-b--blue x-focus-b-orange x-on x-bg-palegray hover-bg-white lh-copy pointer",
    "select-narrow" => "input-reset w-100 w5-ns pa2 pr4 ba br1 x-b--blue x-focus-b-orange x-on x-bg-palegray hover-bg-white lh-copy pointer",
    "textarea" => "input-reset w-100 h4 pa2 ba br1 x-b--blue x-focus-b-orange x-on x-bg-palegray hover-bg-white lh-copy"
  },
  "styles" => %{
    "select" => "appearance: none; background:transparent; background: url(https://cdn.lab.explo.org/images/input_select_arrow.svg) 98% / 4rem no-repeat #F2F2F2;"
  }
}
  end
end
